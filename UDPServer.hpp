...
const double DURATION_THRESHOLD_FOR_DISCONECT = 12.5; // FOR TESTING
const double TIME_DIF_SECONDS_FOR_USER_DISPLAY = 5.5;
//const double TIME_DIF_SECONDS_FOR_PACKET_UPDATE = 0.0045;
const double TIME_DIF_SECONDS_FOR_PACKET_UPDATE = 0.015;
const double TIME_THRESHOLD_TO_RESEND_RELIABLE_PACKETS = 0.150;
